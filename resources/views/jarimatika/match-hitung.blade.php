...
@section('content')
    ...
    <div class="jarimatika-container py-10 px-4 sm:px-6">
        <div class="max-w-4xl mx-auto">
            <div class="text-center mb-10">
                <div
                    class="inline-block bg-[#8B5CF6] text-white px-6 py-2 rounded-full text-xl font-bold uppercase tracking-widest border-b-4 border-[#6D28D9] mb-4 shadow-sm">
                    🧮 Matchmaking Battle Hitung
                </div>
            ...
            <div
                class="game-card border-b-[12px] border-[#8B5CF6] p-8 md:p-12 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8 mb-8 z-10">
                <div class="flex-1 text-center w-full relative z-20">
                    <div
                        class="w-32 h-32 mx-auto bg-purple-100 rounded-full border-[8px] border-[#8B5CF6] flex items-center justify-center text-6xl shadow-inner mb-4 relative z-20">
                        👦
                    </div>
                    <h2 class="text-3xl font-black text-slate-800">{{ $user->name }}</h2>
                    <p class="text-[#8B5CF6] font-bold uppercase tracking-widest mt-1">Siap Bertanding</p>
                </div>
                ...
                <div class="flex-1 text-center w-full relative z-20">
                    <div
                        ...
                        <div class="absolute inset-0 rounded-full border-4 border-[#8B5CF6] opacity-75 radar-pulse z-[-1]">
                        </div>
                    </div>
                    <h2 id="queue-opponent" class="text-3xl font-black text-slate-400">Belum ada</h2>
                    <p id="queue-status" class="text-[#8B5CF6] font-bold uppercase tracking-widest mt-1 animate-pulse">
                        Menunggu lawan...</p>
                </div>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="game-card p-6 border-b-[8px] border-[#8B5CF6]">
                    <h3
                    ...
                    <div class="space-y-4">
                        <div
                            ...
                            <span id="queue-connection"
                                class="bg-[#8B5CF6] text-white px-3 py-1 rounded-xl text-sm font-bold shadow-sm">Terhubung</span>
                        </div>
                        <div
                            class="flex justify-between items-center bg-slate-50 p-3 rounded-2xl border-2 border-slate-100">
                        ...
                        <div
                            ...
                            <span id="queue-hint" class="font-bold text-[#8B5CF6]">Menunggu...</span>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        window.jarimatikaMatchEndpoints = {
            ...
            battleUrl: "{{ route('jarimatika.battle.hitung') }}",
        };
    </script>
