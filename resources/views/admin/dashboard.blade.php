...
@section('content')
    ...
    <div class="admin-container py-8 px-4 sm:px-6">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Navigation -->
            <div class="admin-nav mb-8 flex items-center justify-between flex-wrap gap-4">
                ...
                <div class="flex gap-2 items-center">
                    <a href="/"
                        class="inline-block px-4 py-2 bg-green-100 text-green-700 font-600 rounded-lg hover:bg-green-700 hover:text-white transition-all">
                        🚀 Ke Aplikasi Utama
                    </a>
                    <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                        @csrf
                        <button type="submit"
                            class="inline-block px-4 py-2 bg-red-100 text-red-700 font-600 rounded-lg hover:bg-red-700 hover:text-white transition-all">
                            🚪 Logout
                        </button>
                    </form>
                </div>
